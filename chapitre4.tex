...
les approches de type Visual Analytics ont été peu appliquées à la biologie structurale  %La dissociation actuelle entre analyses et visualisation peut expliquer ce retard dans son implémentation au sein des outils de visualisation et modélisation moléculaire.
...
\subsection{Formalisme pour une représentation sémantique des données moléculaires en Visual Analytics}
