...
Cette complexité peut être abordée par l'intermédiaire du traitement analytique prenant place au coeur de la simulation moléculaire. Plus grande génératrice de nouvelles données, l'étape de simulation est également la principale pourvoyeuse de données brutes à interpréter et analyser et est donc en grande partie responsable de la surcharge de données du processus de biologie structurale.
