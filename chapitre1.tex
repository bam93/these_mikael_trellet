...
L'Acide Désoxyribo-Nucléique (ADN) est une biomolécule commune à tous les organismes vivants. C'est une longue séquence de nucléotides, de quatre types : l' Adénine, la Thymine, la Guanine et la Cytosine. Ces nucléotides partagent partage une structure moléculaire commune constituée d'un sucre, le désoxyribose, et d'un groupe phosphate, cette structure est illustrée dans la Figure \ref{Fig:dna_structure}. 
...
\begin{figure}
  ...
  (b) Les différentes échelles de structuration d'un chromosome, forme condensée de l'ADN. Ce chromosome est lui-même constitué de nucléosomes, composés de brins d'ADN enroulés autour de protéines structurants, les histones.}
\end{figure}
...
Chez les eucaryote, organismes pluricellulaires possédant un noyau dans la cellule, l'ADN est stocké dans le noyau et ne peut en sortir à cause de sa taille trop importante qui l'empêche de traverser la membrane nucléique. Une cellule eucaryote est représentée dans la Figure \ref{cellule} \cite{johnson2011biologie}. 

\begin{figure}
  \centering
  {\includegraphics[width=0.75\linewidth]{./figures/ch1/cellule}}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.6\linewidth]{./figures/ch1/deoxyribose_vs_ribose}}
