...
\begin{figure}[h]
  ...
  \hspace{0.2cm}
  \end{subfigure}
  \caption{\it (a) Représentation en rubans des motifs de structure secondaire les plus communs, à gauche une hélice $\alpha$ et à droite un feuillet $\beta$, résultats de la configuration spatiale des atomes de la chaîne principale des protéines.
...
\begin{figure}
  ...
  \end{subfigure}
  \hspace{0.2cm}
  \caption{\it (a) Schéma simplifié illustrant la technique de cryo-microscopie électronique. Les électrons traversent l'échantillon prisonnier de la glace avant d'atteindre une lentille magnétique qui va les modifier et les projeter sur un scintillateur permettant d'obtenir une image similaire à celle présentée en bas.
