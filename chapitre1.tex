...
\begin{figure}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/dna_structure}}
    \caption{\it Structure chimique de l'ADN mettant en jeu la liaison de nucléotides Adénine (en vert) avec Thymine (en rose) et Cytosine (en rouge) avec Guanine (en violet). Le squelette de l'ADN est composé par la liaison de Phosphates (en jaune) avec un groupement désoxyribose (en orange).}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/chromosome_adn}}
    \caption{\it Les différentes échelles de structuration d'un chromosome, forme condensée de l'ADN. Ce chromosome est lui-même constitué de nucléosomes, composés de brins d'ADN enroulés autour de protéines structurants, les histones.}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/cellule}}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/deoxyribose_vs_ribose}}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/actine_myosine}}
...
Certaine jouent un rôle dans le \textbf{conditionnement de l'ADN}, l'ADN étant enroulé autour de protéines appelées les histones (voir Figure \ref{Fig:chromosome_adn}), 
