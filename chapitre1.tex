...
La cristallographie nécessite également d'observer les protéines dans un environnement non naturel, le cristal, dont la protéine est le seul composant. Elle se déroule en plus à basse température et ne reflète qu'un état unique de la protéine à cette température. Il n'est donc pas possible d'observer de dynamique structurelle.
