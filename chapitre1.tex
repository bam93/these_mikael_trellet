...
L'Acide Désoxyribo-Nucléique (ADN) est une biomolécule commune à tous les organismes vivants. C'est une longue séquence de nucléotides, de quatre types : l' Adénine, la Thymine, la Guanine et la Cytosine. Ces nucléotides partagent une structure moléculaire commune constituée d'un sucre, le désoxyribose, et d'un groupe phosphate, cette structure est illustrée dans la Figure \ref{Fig:dna_structure}. 
...
\begin{figure}
  ...
  \begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=0.75\linewidth]{./figures/ch1/chromosome_adn_2}}
    \caption{}
  ...
  (b) Les différentes échelles de structuration d'un chromosome, forme condensée de l'ADN. Ce chromosome est lui-même constitué de nucléosomes, composés de brins d'ADN enroulés autour de protéines structurantes, les histones.}
\end{figure}




À cette partie commune se lie une base azotée spécifique à chacun des 4 types de nucléotides. Les nucléotides s'organisent en séquence de deux brins en complémentarité. L'Adénine se liant à la Thymine et la Guanine se liant à la Cytosine. 
...
L'ADN est lui-même organisé en structures plus complexes allant du nucléosomes aux chromosomes. Ces chromosomes permettent à l'ADN d'être plus compact et sont aussi un élément de la 
...
Chez les eucaryotes, organismes pluricellulaires possédant un noyau dans la cellule, l'ADN est stocké dans le noyau et ne peut en sortir à cause de sa taille trop importante qui l'empêche de traverser la membrane nucléique. Une cellule eucaryote est représentée dans la Figure \ref{cellule} \cite{johnson2011biologie}. 

\begin{figure}
  \centering
  {\includegraphics[width=0.95\linewidth]{./figures/ch1/cellule}}
    \caption{\it Cellule eucaryote en coupe horizontale. Les différentes organites de la cellule sont labellisées. L'ADN est contenu sous forme chromosomique dans le nucléole et doit traverser les pores nucléaires pour accéder au cytoplasme.}
    \label{Fig:cellule}
  \hspace{0.3cm}
\end{figure}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.75\linewidth]{./figures/ch1/actine_myosine}}
    \caption{\it Illustration de l'interaction entre un filament de myosine et un brin d'actine, troponine et tropomyosine. Cette interaction est impliquée dans la mobilité cellulaire utilisée notamment pour la contraction musculaire.}
    \label{Fig:actine_myosine}
  \hspace{0.3cm}
\end{figure}

Certaine jouent un rôle dans le \textbf{conditionnement de l'ADN}, l'ADN étant enroulé autour de protéines appelées les histones (voir Figure \ref{Fig:chromosome_adn}), d'autres sont impliqués dans la \textbf{régulation de l'expression génétique}, comme les facteurs de transcription accompagnant l'ARN polymérase lors de la transcription (voir Figure \ref{Fig:RNA_pol_II}).
...
Une protéine est constituée d'une succession d'acides aminés. Au sein des protéines présentes chez les êtres vivants, il existe 22 acides aminés différents. Parmi ces 22 acides aminés, 19 d'entre eux ne sont constitués que de quatre atomes distincts: le carbone, l'hydrogène, l'oxygène et l'azote (voir Figure \ref{Fig:amino_acid_structure}). Deux autres possèdent également un atome de soufre et enfin le dernier, plus rare, possède un atome de sélénium. 
...
\begin{figure}
  \centering
  {\includegraphics[width=0.75\linewidth]{./figures/ch1/transc_trad_HD.pdf}}
    \caption{\it Schéma simplifié des étapes de transcription et de traduction. On peut voir que l'information gnétique portée par l'ADN double-brin sous forme de séquences de triplets d'acides nucléiques est copié en l'ARNm pour pouvoir travers la paroi nucléaire et rejoindre un ribosome qui fera l'interface entre les codons de nucléotides et les acides aminés correspondant portés par les ARNt.}
...
\begin{figure}
  \centering
  {\includegraphics[width=0.75\linewidth]{./figures/ch1/cryoem.pdf}}
...
où les énergies des contributions covalentes (interactions liées), résultats de liaisons fortes entre les atomes et difficiles à défaire, et non covalentes (interactions non liées), liaisons à longue distance principalement plus faibles que les précédentes, sont données par les calculs suivants:
...
\subsubsection{Evolution du graphisme moléculaire}
...
\myparagraph{Représentations virtuelles par ordinateur}
...
\subsubsection{La visualisation moléculaire aujourd'hui}
