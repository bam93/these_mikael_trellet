...
% \commentaire{MB: euh.. courant, non, la plupart des champs de force gros grain sont incapable de faire du repliement car on leur impose une strucutre de reference, e.g. un modele de ressorts dans Martini; quelques-uns, plutot rares, comme OPEP sous certaines conditions, sont capables de faire du repliement seulement}
