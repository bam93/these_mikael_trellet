...
\begin{figure}[h]
  \centering
  {\includegraphics[width=.8\linewidth]{./figures/ch1/process_bio_struct_XP}}
...
\begin{figure}
  \begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/cryoem.pdf}}
    \label{Fig:cryoem}
  \end{subfigure}
  \hspace{0.2cm}
  \begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=0.3\linewidth]{./figures/ch1/cryoem_density.png}}
...
\subsubsection{Modèles théoriques de représentation d'une protéine}
