...
\setcounter{secnumdepth}{2}% enlève la numérotation après les sections
\usepackage{titlesec}
...
% Table des mati�res
\cleardoublepage
\setcounter{tocdepth}{2} % pour r�gler sa profondeur - par d�faut : 2
...
\include{chapitre3}
% \include{partie2}
% \include{./ch4/chapitre4}
% \include{./ch5/chapitre5}
% \include{./ch6/chapitre6}
