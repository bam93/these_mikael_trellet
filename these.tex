...
% Afin de compiler une version light sans figures
% \usepackage{comment}
...
%   {\lstset{language=XML,float=tb,#1}}% \begin{javalisting}[...]
%   {} % \end{javalisting}

% To add a border to certain images with includegraphics option "frame"
\usepackage[export]{adjustbox}

\usepackage[titletoc]{appendix}
% =========================== Info du document =================================

\title{Exploration et analyse immersives de données moléculaires guidées par la tâche et la modélisation sémantique des contenus}
...
%% Abstract
\cleardoublepage
% \pdfbookmark[0]{Résumé / Abstract}{resume}
% \include{resume}
...
% \appendix
\include{appendix} % chorus digitalis
