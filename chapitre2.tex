...
\subsection{La perception 3d et de l'immersion au service de la visualisation moléculaire}
...
\begin{figure}[h]
  ...
  % \hspace{0.3cm}
  \end{subfigure}
  \caption[Système haptique \textit{the Docker}. (b) Système haptique Phantom. (c) Système haptique permettant la manipulation d'une protéine.]{\it (a) Système haptique appelée \textit{the Docker} conçu et construit par Ming Ouh-young et permettant de simuler les forces et les torsions dues aux interactions électrostatiques entre les deux molécules.
