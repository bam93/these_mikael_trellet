...
\subsubsection{Malaise virtuel ou \textit{cybersickness}} \label{cybersickness}
...
La création d'un monde virtuel ne possède pas de restrictions spatiales, la navigation est donc indissociable de la plupart des expériences virtuelles afin de permettre à l'utilisateur de parcourir l'intégralité du monde modélisé. Cependant, les techniques de navigation doivent faire face à une restriction physique dans le monde réel, ne pouvant étendre à l'infini l'espace où évolue les utilisateurs. Différents paradigmes existent répondant à cette problématique.
