...
\begin{figure}
  \centering
  {\includegraphics[width=.75\linewidth]{./figures/ch2/eve_cave_system}}
...
\begin{figure}
  ...
  {\includegraphics[width=.75\linewidth]{./figures/ch2/pymol_stereo}}
    \caption{{\it Capture d'écran de PyMol exécuté en mode stéréoscopique "cross_eyes". L'image de la protéine de droite correspond à l’œil gauche et inversement}}
