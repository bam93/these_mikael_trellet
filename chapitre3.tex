...
\begin{figure}[htb]
  ...
  {\includegraphics[width=.5\linewidth]{./figures/ch3/degree_of_freedom_glic}}
    \caption[Représentation des chemins de navigation générés en exploration externe et interne d'un complexe moléculaire.]{{\it Suivant sa position relative au complexe et dépendant du mode de navigation, la caméra possède un nombre de degrés de liberté prédéfinis en terme de position. Dans notre illustration, les mouvements de translation possibles sont représentés en rouge alors que les points de vue autorisés sont représentés par des flèches noires. Au cours d'une navigation verticale, la caméra est contrainte sur un axe parallèle à l'axe de symétrie (en vert) à l'extérieur de la protéine (en haut à gauche) ou à l'intérieur (en haut à droite). Une navigation extérieure contraint le vecteur forward de la caméra à faire face à la protéine alors qu'à l'intérieur la caméra peut tourner à 360 degrés. Enfin, les chemins de navigation horizontaux à l'extérieur de la protéine (en bas) contraignent le vecteur right de la caméra de façon à ce qu'ils soient circulaires ou perpendiculaires par rapport à l'axe de la protéine.}}
...
Par ailleurs, ce paradigme a été adapté à d'autres types de symétrie notamment pour les symétries centrales. Dans ce cas le degré de liberté permettant de modifier la distance du point de vue par rapport à l'objet d'intérêt est conservée, avec deux degrés de liberté pour la rotation autour de la molécules à la place d'un seul pour les symétries axiales, la notion d'altitude le long d'un axe n'ayant plus de sens dans le cas de la symétrie centrale. Nous avons mis en place ces calculs de chemins préférentiels en s'inspirant de techniques utilisées dans d'autres cadres \cite{khan_hovercam:_2005,hanson_constrained_1997}.

Les deux modes d'exploration externes et internes sont illustrés dans les Figures \ref{Fig:unitymol_external_exploration} et \ref{Fig:unitymol_internal_exploration} à partir de notre implémentation des paradigmes au sein du logiciel expert UnityMol \cite{lv2013game}. 
...
\begin{figure}[htb]
  ...
  \centering
  {\includegraphics[width=.95\linewidth]{./figures/ch3/unitymol_external_exploration}}
    \caption{}
  \label{Fig:unitymol_external_exploration}
  % \hspace{0.3cm}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=.95\linewidth]{./figures/ch3/unitymol_internal_exploration}}
    \caption{}
  \label{Fig:unitymol_internal_exploration}
  % \hspace{0.3cm}
\end{subfigure}
    \caption[Captures d'écran de l'exploration guidée dans UnityMol]{{\it Implémentation de nos paradigmes de navigation guidée au sein de UnityMol pour l'exploration de GLIC (représenté en sphères) autour d'un axe de symétrie (en rouge, invisible dans la version publique). (a) Capture d'écran d'un point de vue utilisateur pendant une exploration externe de la protéine GLIC.
    (b) Capture d'écran d'un point de vue utilisateur pendant une exploration externe de la protéine GLIC.}}
  % \hspace{0.2cm}
\end{figure}
...
\begin{figure}[htb]
  \centering
  {\includegraphics[width=.8\linewidth]{./figures/ch3/voronoi_diagram}}
...
\begin{figure}[htb]
  ...
  {\includegraphics[width=.5\linewidth]{./figures/ch3/optimal_pov_camera_path}}
    \caption[Schéma de l'algorithme de recherche du meilleur chemin de caméra pour atteindre un point de vue optimal.]{{\it Schéma de l'algorithme de recherche du meilleur chemin de caméra pour atteindre un point de vue optimal. La cible à visualiser est représentée en vert et ses atomes voisins en rouge. Chaque cercle représente une distance précise entre la caméra et la cible, le plus petit désignant la distance de caméra désirée. Pour chaque distance, l'algorithme de point de vue optimal est répété afin d'obtenir les meilleurs point de vue sur la cible. Les cônes bleus représentent les cônes de vue les plus larges trouvés alors qu'en vert et violet sont représentés les aires vides les plus larges entre les différentes distances de caméra. Le chemin qu'empruntera la caméra pour atteindre le point de vue optimal est représenté grâce aux symboles de couleur noire.}}
...
\begin{figure}[h]
  \begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=.95\linewidth]{./figures/ch3/unitymol_optimal_pov}}
    \caption{}
  \label{Fig:unitymol_optimal_pov}
  % \hspace{0.3cm}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=.95\linewidth]{./figures/ch3/unitymol_optimal_pov2}}
    \caption{}
  \label{Fig:unitymol_optimal_pov2}
  % \hspace{0.3cm}
\end{subfigure}
    \caption[Captures d'écran de la recherche de point de vue optimale dans UnityMol]{{\it Implémentation de nos paradigmes de navigation guidée au sein de UnityMol pour l'exploration de GLIC (représenté en sphères) autour d'un axe de symétrie (en rouge, invisible dans la version publique). (a) Capture d'écran d'un point de vue utilisateur pendant une exploration externe de la protéine GLIC.
    (b) Capture d'écran d'un point de vue utilisateur pendant une exploration externe de la protéine GLIC.}}
  % \hspace{0.2cm}
\end{figure}
...
\subsubsection{Évaluation par analyse hiérarchique de la tâche} \label{hta_eval}
...
\begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=.65\linewidth]{./figures/ch3/depthmol3d_process_edit}}
    \caption{}
...
\begin{subfigure}{.5\textwidth}
  \centering
  {\includegraphics[width=.65\linewidth]{./figures/ch3/heightmap_texture_unity_edit}}
    \caption{}
...
%   \centering
%   {\includegraphics[width=.9\linewidth]{./figures/ch3/depthmol3d_exemple}}
%     \caption{}
...
%   \centering
%   {\includegraphics[width=.9\linewidth]{./figures/ch3/depthmol3d_screenshots}}
%     \caption{}
...
\begin{figure}[htb]
  \centering
  {\includegraphics[width=.65\linewidth]{./figures/ch3/molexplorer_screenshot.png}}
