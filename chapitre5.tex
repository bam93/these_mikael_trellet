...
\begin{figure}
  \centering
  {\includegraphics[width=1.00\linewidth]{./figures/ch5/ontology}}
...
Notre implémentation de SPARQL a pris plusieurs formes afin de répondre à plusieurs besoins au sein de notre plateforme. Le premier besoin identifié et utilisé comme preuve de concept de notre structure ontologie OWL/base de données RDF fut la mise en place d'un moteur de conversion de mots-clés en commandes logicielles.
